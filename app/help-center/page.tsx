...
export const metadata: Metadata = {
  ...
  description:
    "Find answers to common questions about activating your software key, delivery, refunds, and more. Keyversely LLC customer support for actualkeys.com.",
  alternates: { canonical: "https://www.actualkeys.com/help-center" },
  robots: { index: true, follow: true },
  openGraph: {
    type: "website",
    url: "https://www.actualkeys.com/help-center",
    title: "Help Center | Keyversely LLC",
    description:
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: "Help Center",
      item: "https://www.actualkeys.com/help-center",
    },
  ],
};
