const BUSINESS = {
  ...
  addressDisplay: "63 N Burritt Ave, Rm 100 PMB 1180\nBuffalo, Wyoming 82834\nUnited States",
  website: "https://www.actualkeys.com",
...
const rows: Row[] = [
  ...
  { label: "Website",         value: BUSINESS.website.replace("https://", ""), href: BUSINESS.website, type: "link" },
  { label: "Email",           value: BUSINESS.email, href: `mailto:${BUSINESS.email}`, type: "link" },
  { label: "Phone",           value: BUSINESS.phone.display, href: BUSINESS.phone.href, type: "link" },
...
export default function AboutBusinessInfo() {
  return (
    <section className="mb-12 rounded-xl border border-border bg-muted/40 p-7">
      <h2 className="text-2xl font-bold mb-5 text-foreground">Business Information</h2>
