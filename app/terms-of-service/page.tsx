...
export const metadata: Metadata = {
  ...
  description:
    "Read the Terms of Service for Keyversely LLC (actualkeys.com). Understand your rights and responsibilities when purchasing digital software licenses from our store.",
  alternates: { canonical: "https://www.actualkeys.com/terms-of-service" },
...
const schema = {
  ...
  url: "https://www.actualkeys.com/terms-of-service",
  inLanguage: "en-US",
  publisher: {
    "@type": "Organization",
    name: "Keyversely LLC",
  ...
  breadcrumb: {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: "https://www.actualkeys.com/terms-of-service",
      },
    ],
  },
};
      ...
      <main className="max-w-2xl mx-auto px-6 py-14">
        ...
        <section className="mb-10">
          <p className="text-base text-muted-foreground leading-relaxed mb-3">
            ...
            (actualkeys.com) and any purchase you make from us. By accessing our
            site or placing an order, you agree to these terms. Please read them
            before you buy.
          </p>
        ...
        <section className="mb-10">
          ...
          <p className="text-base text-muted-foreground leading-relaxed">
            ...
            software store at actualkeys.com, selling genuine software
            activation keys for personal and business use.
          </p>
        </section>
