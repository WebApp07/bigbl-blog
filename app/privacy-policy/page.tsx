...
export const metadata: Metadata = {
  ...
  description:
    "Keyversely LLC is committed to protecting your privacy. Learn how we collect, use, and protect your personal information when you shop at actualkeys.com.",
  alternates: { canonical: "https://www.actualkeys.com/privacy-policy" },
...
const schema = {
  ...
  url: "https://www.actualkeys.com/privacy-policy",
  inLanguage: "en-US",
  publisher: {
    "@type": "Organization",
    name: "Keyversely LLC",
  ...
  breadcrumb: {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Privacy Policy",
        item: "https://www.actualkeys.com/privacy-policy",
      },
    ],
  },
};
      ...
      <main className="max-w-2xl mx-auto px-6 py-14">
        ...
        <section className="mb-10">
          <p className="text-base text-muted-foreground leading-relaxed mb-3">
            ...
            actualkeys.com. This Privacy Policy explains what information we
            collect when you visit or make a purchase from our store, how we use
